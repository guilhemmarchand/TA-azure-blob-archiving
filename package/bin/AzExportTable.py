...
filehandler = logging.FileHandler(
    splunkhome + "/var/log/splunk/azure2blob_azexporttable.log", "a"
)
...
class AzExportToTable(StreamingCommand):
    ...
    def stream(self, records):
        ...
        try:
            ...
            logging.error(
                "Failed to establish the service to the Azure table with exception="
                + str(e)
            )
        ...
        logging.info(
            "There are "
            + str(results_count)
            + " records to be processed into the Azure table"
        )
        ...
        for chunk in chunks:
            ...
            for subrecord in chunk:
                ...
                try:
                    ...
                    logging.error(
                        "Error inserting record in table with exception: " + str(e)
                    )
