...
# set logging
filehandler = logging.FileHandler(splunkhome + "/var/log/splunk/azure2blob_azpurgeblob.log", 'a')
            ...
            for subrecord in chunk:
                ...
                #
                    ...
                    try:
                        ...
                        container_client = blob_service_client.get_container_client(subrecord_PartitionKey)
