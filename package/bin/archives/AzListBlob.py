...
if __name__ == "__main__":
    searchable = False
    if len(sys.argv) != 2:
        sys.exit('usage: python3 AzListBlob.py <container_name>')

    container_name = sys.argv[1]
    container = ContainerClient.from_connection_string(AZ_BLOB_CONNECTION_STRING, container_name=container_name)
